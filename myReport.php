    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-secondary" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="myReport.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3" style="color: white; font-weight: bold; text-transform: uppercase; text-align: center;">My Report</h3>
                   
                   
                    <div class="table-responsive">
                    <div class="tbodyDiv">

                        <table class="table bg-white rounded shadow-sm  table-hover table-striped " id="table" >
