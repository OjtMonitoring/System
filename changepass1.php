        ...
        <div class="bg-secondary" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
             <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                ...
                <a href="attendanceSuper.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
...
if(isset($_POST['submit'])){
    ...
    if($new == $confirm){
        $query="SELECT * FROM supervisor ojtstudent WHERE password = '$old' and username='$username'";
