    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-secondary" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="createReport.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-chart-line me-2"></i>Create Report</a>
                <a href="myReport.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-paperclip me-2"></i>My Report</a>
        ...
        <div id="page-content-wrapper">
            ...
            $code = $user_data['code'];
			$sql = "SELECT * FROM attendance where code = '$code'";
