...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-secondary" id="sidebar-wrapper">
            ...
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom" style="color:#fff;">OJT <span>MONITORING</span></div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3" style="color: white; font-weight: bold; text-transform: uppercase; text-align: center;">OJT Students Attendance</h3>
                    <div class="col">
                   
                    <div class="table-responsive">
                    <div class="tbodyDiv">
                        <table class="table bg-light rounded shadow-sm  table-hover table-striped mb-0" id="table">
                          
                        <thead class="sticky-top bg-dark" style="color:#fff;">
                            <tr>
                                <th style="text-align: center;">OJT Name</th>
			...
			$sql = "SELECT * FROM ojtstudent where supervisorname = '$code'";
