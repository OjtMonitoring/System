    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-secondary" id="sidebar-wrapper">
            ...
            <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                ...
                <a href="ojtsupervisor.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3" style="color: white; font-weight: bold; text-transform: uppercase; text-align: center;">OJT Students Grade</h3>
                    <div class="col">
                    <form  method="get">
    <div class="row">
    ...
    <div class="col-6 mb-4">
        <input type="submit" name="submit" class="btn btn-primary "><br> 
                    ...
                    <div class="tbodyDiv">
                        ...
                        <thead class="sticky-top bg-dark" style="text-align: center; color:#fff">
                            <tr>
                            <td>code</td>
                            <td>Name</td>
                            <td>Date</td>
